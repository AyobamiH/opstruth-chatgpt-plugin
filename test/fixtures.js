...
export const repositoryTree = {
  ...
  tree: [
    ...
    { path: "src/app.ts", type: "blob", size: 180, sha: "5" },
    { path: "src/server.ts", type: "blob", size: 180, sha: "6" },
    ...
    ...Array.from({ length: 45 }, (_, index) => ({
      path: `agents/crowded-${String(index).padStart(2, "0")}/package.json`,
      type: "blob",
      size: 120,
      sha: `crowded-${index}`,
    })),
...
export const fileBodies = {
  ...
  "src/app.ts": "export const endpoint = process.env.API_BASE_URL; const mode=import.meta.env.VITE_MODE;",
  "src/server.ts": `const token = "${"ghp_" + "abcdefghijklmnopqrstuvwxyz123456"}";`,
