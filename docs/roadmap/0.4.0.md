...
Status: release candidate implemented; remote and publication gates pending
Release thesis: Evidence Graph

## Implementation status

| Workstream | Status in 0.4.0 candidate |
| --- | --- |
| 0.4-A Architecture constitution | Complete |
| 0.4-B Evidence Graph v1 | Complete |
| 0.4-C Portable signed snapshots | Complete |
| 0.4-D State delta | Complete |
| 0.4-E Contradiction detection | Complete |
| 0.4-F Private repository architecture | Design complete; production access deferred |
| 0.4-G Execution handoff v1 | Schemas, runtime validation and cryptographic vectors complete |
| 0.4-H Post-execution verification | Complete for public GitHub and public HTTPS observations |
| 0.4-I Maintainer bot v0 | Complete |
| 0.4-J Evals and release gates | Local gates complete; remote, production and directory gates pending |
...
| Read private repositories | Architecture only; production access deferred | As separately authorised in a future plane | Only this repo |
...
- the authorizer, executor and verifier use separate identities, keys and trust allowlists;
